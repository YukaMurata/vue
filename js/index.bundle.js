...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_Match__ = __webpack_require__(10);


new __WEBPACK_IMPORTED_MODULE_0__modules_Match__["a" /* default */]();
...
class Match {
   ...
   */
  createVue() {
    this.listItem = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
      el: '#list',
      data: {
        // Jsonデータ格納用
        search_list: [],
      ...
      created() {
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('./json/maches.json').then(response => {
          __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(this, 'match', response.data);
